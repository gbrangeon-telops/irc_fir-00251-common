...
else
{
   ...
   AXI4L_write32(1, XPAR_M_BUFFERING_CTRL_BASEADDR + BM_LVAL_PAUSE_MIN); // C'est un generique defini dans le pleora_intf.bde (LPauseLen)
   AXI4L_write32(16, XPAR_M_BUFFERING_CTRL_BASEADDR + BM_FVAL_PAUSE_MIN); // C'est un generique defini dans le pleora_intf.bde (FPauseLen)
}
